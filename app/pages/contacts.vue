<template>
  <SharedContainer>
    <UIBlogWrapper>
      ...
      />
      <UIArticleBlock>
        Use the following form to contact Dutch for Developers. All fields are
        required.
      </UIArticleBlock>
      <form
        name="dfd_contacts"
      ...
      >
        ...
        <div
          v-if="error"
          class="border mt-2 border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700"
        >
          <p>
...
useHead({
  title: "Contact Dutch for Developers - Dutch for Developers",
});
...
function handleSubmit(event: SubmitEvent) {
  ...
  fetch("/", {
    ...
    .catch(() => (error.value = true)); //TODO: refactor with error message
}
