<template>
    <Container>
        <UIBlogWrapper>
            <UIBanner v-if="unauth">You need to login to view this section</UIBanner>
            ...
            <section class="flex flex-col gap-3 my-12 justify-center max-w-md mx-auto">
                <button
                    ...
                    @click="$store.dispatch('user/githubAuth')"
                >
                ...
                <button
                    ...
                    @click="$store.dispatch('user/linkedinAuth')"
                >
                    <span class="flex gap-2 items-center">
                        <v-icon name="brands/linkedin" class="fill-current" />
