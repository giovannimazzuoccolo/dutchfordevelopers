    ...
    <div class="relative">
      <GamesSuccess v-if="success">
        ...
        <div class="flex gap-4">
          <UIButton v-if="checkScore()" @click="saveScore">Save </UIButton>
      ...
      <p class="my-4 dark:text-white">
        Play passport control, put the verbs in the right queue and keep the
...
function confirmChoice() {
  ...
  if (
    solutionForm === form.value &&
    solutionPerson === person.value &&
    regularOrIrregular === regularOrIrregularValue.value
  ) {
    score.value++;
