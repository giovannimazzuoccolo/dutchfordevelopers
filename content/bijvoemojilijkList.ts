...
export interface ResultEmojiList {
    english: string
    emoji: string
    dutch?: string
}

export const otherEmojisWithNames = [
    { english: 'waving hand', emoji: '👋' },
    { english: 'cold face', emoji: '🥶' },
    { english: 'smiling imp', emoji: '😈' },
    { english: 'money', emoji: '🤑' },
    { english: 'lying', emoji: '🤥' },
    { english: 'officer', emoji: '👮‍♀️' },
    { english: 'farmer', emoji: '👨‍🌾' },
    { english: 'tshirt', emoji: '👕' },
    { english: 'cherries', emoji: '🍒' },
    { english: 'snowboarder', emoji: '🏂' },
]
